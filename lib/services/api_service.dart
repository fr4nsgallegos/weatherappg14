...
class ApiService {
  ...
  Future<WeatherModel?> getWeatherInfoByPos(double lat, double long) async {
    final url = Uri.parse(
      "$urlBase/current.json?key=70866d7ade244a3c9ca20142230509&q=$lat,$long&aqi=no",
    );
  ...
  Future<ForecastModel?> getForecastInfoByCity(String city) async {
    final url = Uri.parse(
      "$urlBase/forecast.json?key=70866d7ade244a3c9ca20142230509&q=$city&aqi=no",
    );
